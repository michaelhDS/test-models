...
setuptools.setup(
    name='KNNModel',
    version='20210627132447_60651F',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - KNNModel:20210627132447_60651F
...
A minimum prediction service exposing a Scikit-learn model""",
    ...
    package_data={
        'KNNModel': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'KNNModel=KNNModel:cli',
        ],
    }
)
